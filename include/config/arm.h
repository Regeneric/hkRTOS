...
#include <defines.h>
    ...
    #if hkDHT_USE_SENSOR
        #define hkDHT_11                        false                           // DHT11 - temperature and humidity, no decimal points, custom protocol
        #define hkDHT_20                        true                            // DHT20 - temperature and humidity, single precision, I2C
        #define hkDHT_22                        true                            // DHT22 - temperature and humidity, single precision, custom protocol
    ...
    #define hkOLED_SSD1327                      true                            // Waveshare 13992 1.5" OLED
        ...
        #if hkSSD1327_USE_I2C
            #define SSD1327_ADDRESS             0x3C    //  Or 0x3D             // I2C address
        #endif
    #endif
